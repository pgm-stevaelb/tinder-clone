...
router.get('/matches/:userId/:friendId', matchController.getMatchByIds);
router.post('/matches', matchController.createMatch);
router.put('/matches/:userId/:friendId', matchController.updateMatch);
router.delete('/matches/:userId/:friendId', matchController.deleteMatch);
